---
id: official-links
title: Enlaces oficiales y soporte
sidebar_label: Enlaces oficiales y soporte
sidebar_position: 3
description: Enlaces verificados del sitio web oficial de UXUY, la descarga de la aplicación, las redes sociales y los recursos de marca.
keywords: [enlaces oficiales, sitio web oficial, descarga, Telegram, X, recursos de marca]
---

# Enlaces oficiales y soporte

A continuación se indican los enlaces oficiales de UXUY:

| Tipo | Enlace |
| --- | --- |
| Sitio web oficial | [https://uxuy.com/](https://uxuy.com/) |
